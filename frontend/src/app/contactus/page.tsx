            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="flex items-start mb-6">
                <div className="flex-shrink-0">
                  <svg
                    ...
                    className="h-6 w-6 text-rose-600 mt-1"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-600">hello@cozycrochet.com</p>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-600">123 Yarn Street</p>
                  <p className="text-gray-600">Craftsville, CR 12345</p>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="mt-1 block w-full border-gray-300 py-2 rounded-md shadow-sm focus:ring-rose-500 focus:border-rose-500 sm:text-sm"
                    />
                  </div>
                  <div>
                    <label
                  ...
                  <div className="flex items-center justify-end">
                    <button
                      ...
                      className={`inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-rose-600 hover:bg
                      -rose-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500 ${
